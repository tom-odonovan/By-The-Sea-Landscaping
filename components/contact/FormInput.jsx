            ...
            { type === 'textarea' ? (
                <label className="relative">
                    <textarea
                        ...
                        className={`appearance-none bg-gray-100/50 text-[14px] border-[1px] border-palette-1/50 rounded w-full min-h-[150px] p-4 text-gray-700 leading-tight ${error && touched ? 'focus:ring-pink-500 focus:border-pink-500 border-pink-500' : 'focus:border-palette-2 focus:ring-palette-2 focus:shadow-md'}`}
                    />
                ...
                <label className="relative">
                    <input
                        ...
                        value={value}
                        onChange={handleChange}
                        className={`appearance-none text-[14px] bg-gray-100/50 border-[1px] border-palette-1/50 rounded w-full p-4 text-gray-700 leading-tight ${error && touched ? 'focus:ring-pink-500 focus:border-pink-500 border-pink-500' : 'focus:border-palette-2 focus:ring-palette-2 focus:shadow-md'}`}
                    />
