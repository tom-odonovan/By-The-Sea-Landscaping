            ...
            { type === 'textarea' ? (
                <label className="relative">
                    <textarea
                        ...
                        className={`appearance-none bg-gray-100/50 text-[14px] border-[1px] border-gray-300 rounded w-full min-h-[150px] p-4 text-gray-700 leading-tight ${error && touched ? 'focus:ring-pink-500 focus:border-pink-500 border-pink-500' : 'focus:border-palette-2 focus:ring-palette-2 focus:shadow-md'}`}
                    />
