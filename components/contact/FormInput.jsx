  ...
  <div className="flex flex-col flex-grow gap-1">
    ...
    {type === 'textarea' ? (
      <label className="relative">
        ...
        />
        <span className={`absolute left-2 top-2 px-2 h-[25px] text-[14px] text-gray-500 transition duration-200 input-textarea ${value ? 'font-bold bg-none transform -translate-y-10 -translate-x-4' : ''}`}>{placeholder}</span>
      ...
      <label className="relative">
        ...
        />
        <span className={`absolute left-2 top-2 px-2 h-[25px] text-[14px] text-gray-500 transition duration-200 input-text ${value ? 'font-bold bg-none transform -translate-y-10 -translate-x-4' : ''}`}>{placeholder}</span>
