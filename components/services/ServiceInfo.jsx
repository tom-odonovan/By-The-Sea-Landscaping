...
import { Carousel, ContactCard } from '../../components';
        ...
        <div className='flex flex-col gap-8 justify-start items-center py-12 lg:pr-[150px]'>
          <div className='flex flex-row justify-center items-center mt-12'>
            ...
            <div {...handlers} className='w-[90vw] sm:w-[80vw] lg:max-w-[550px] xl:max-w-[700px] 2xl:max-w-[800px] h-full overflow-hidden'>
              <div className={`h-auto flex flex-row -translate-x-[${activeIndex * 100}%] transition duration-500`}>
                {services.map((item, index) => (
                  // carousel item
                  <div className="flex flex-col justify-center min-w-[90vw] sm:min-w-[80vw] lg:min-w-[550px] xl:min-w-[700px] 2xl:min-w-[800px] px-2 gap-8 px-0 lg:px-16">
