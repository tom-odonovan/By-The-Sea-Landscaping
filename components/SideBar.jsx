...
const SideBar = ({ active, handleClick }) => {
  ...
  return (
    <div>
      <div className={`${active ? 'translate-x-0' : 'translate-x-full'} transition duration-[.6s] ease-in-out p-8 flex flex-col fixed top-0 right-0 bg-white w-3/4 sm:w-[350px] h-full shadow-2xl opacity-100 z-5 overflow-y-auto flex-grow`}>
