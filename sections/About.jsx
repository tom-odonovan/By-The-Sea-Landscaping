...
const About = () => (
  <section className={`${styles.paddings} mt-[750px] relative z-10`}>
    <div className="bg-[url('/wallpaper.png')] bg-cover opacity-20">
    ...
    >
      ...
      <motion.p
        ...
        className='mt-[50px] px-[50px] font-normal md:text-[16px] sm:text-[14px] text-[12px] text-center'
      >
